 ...
 */
public class TestPerfTableSansPK {

    public static void sansClefCrea(Connection con) {
        long debutRequete = System.nanoTime();

        try {
            String query = "INSERT INTO table100_sans_pk(entier, string) VALUES(?, ?)";
        ...
        try {
            String query = "INSERT INTO table10000_sans_pk(entier, string) VALUES(?, ?)";
    ...
    public static void sansClefSelectSimple(Connection con) {
        ...
        try {
            String query = "SELECT COUNT(table10000_sans_pk.string) "
                    + "FROM table10000_sans_pk "
                    + "INNER JOIN table100_sans_pk ON (table100_sans_pk.string = table10000_sans_pk.string)";
    ...
    public static void sansClefSelectCondition(Connection con) {
        ...
        try {
            String query = "SELECT COUNT(table10000_sans_pk.string) "
                    + "FROM table10000_sans_pk "
                    + "INNER JOIN table100_sans_pk ON (table100_sans_pk.string = table10000_sans_pk.string) "
                    + "WHERE table10000_sans_pk.string LIKE '%a'";
    ...
    public static void sansClefSelectOrdre(Connection con) {
        ...
        try {
            String query = "SELECT table10000_sans_pk.string "
                    + "FROM table10000_sans_pk "
                    + "INNER JOIN table100_sans_pk ON (table100_sans_pk.string = table10000_sans_pk.string) "
                    + "WHERE table10000_sans_pk.string LIKE '%a' ORDER BY table10000_sans_pk.string";
