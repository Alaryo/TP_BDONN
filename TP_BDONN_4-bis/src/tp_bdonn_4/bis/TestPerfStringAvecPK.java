 ...
 */
public class TestPerfStringAvecPK {

    public static void sansClefCrea(Connection con) {
        long debutRequete = System.nanoTime();

        try {
            String query = "INSERT INTO string_avec_pk(pk, string) VALUES(?, ?)";
    ...
    public static void sansClefSelectSimple(Connection con) {
        ...
        try {
            String query = "SELECT COUNT(pk) FROM string_avec_pk";
        ...
        System.out.println("Le temps de SELECT(*) des string dans une table avec PK "
    ...
    public static void sansClefSelectCondition(Connection con) {
        ...
        try {
            String query = "SELECT COUNT(pk) FROM string_avec_pk WHERE pk = 100";
        ...
        System.out.println("Le temps de SELECT les string terminant par 100 "
    ...
    public static void sansClefSelectOrdre(Connection con) {
        ...
        try {
            String query = "SELECT pk FROM string_avec_pk WHERE pk = 100 ORDER BY pk";
